...
//     // Storing the first element of the Priority Queue This first element is also the smallest element
//     int prev = pq.top();
//     pq.pop();
...
//         // check if current peek element minus previous element is greater than 1 This is done because if it's greater than 1 then the sequence doesn't start or is broken here
//         if (pq.top() - prev > 1)
//         {

//             // Store the value of counter to 1 As new sequence may begin
//             c = 1;
